...
from detectors.Reveal.configurations import model_args, data_args, train_args
...
class TrainUtil(object):
    def __init__(self, w2v_model: Word2Vec, gnnNets: ClassifyModel, vul_type: str, abspath: str):
    ...
    def evaluate(self, eval_dataloader):
        ...
        with torch.no_grad():
            for batch_graph_info in eval_dataloader:
                batch_data = [self.reveal_util.generate_initial_graph_embedding(graph_info) for graph_info in tqdm(batch_graph_info,
                                                                                                                   desc="generate graph embedding",
                                                                                                                   file=sys.stdout)]
    ...
    def predict_single(self, data: Data):
        self.gnnNets.eval()
