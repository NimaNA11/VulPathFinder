...
vul_file = f"{data_args.dataset_dir}/slice/train_vuls.json"
nor_file = f"{data_args.dataset_dir}/slice/train_nors.json"
...
class Sentences:
    def __init__(self):
        self.datas: list = json.load(open(vul_file, 'r', encoding='utf-8')) + json.load(open(nor_file, 'r', encoding='utf-8'))
