...
from detectors.IVDetect.configurations import model_args, data_args, train_args
...
class TrainUtil(object):
    def __init__(self, w2v_model: Word2Vec, gnnNets: IVDetectModel, vul_type: str, abspath: str):
