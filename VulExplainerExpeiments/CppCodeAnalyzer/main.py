...
# Add the parent directory (or the directory containing vul_explainer) to sys.path
sys.path.insert(0, '/home/nimana11/Thesis/codes/VulExplainerExp-84ED_2/VulExplainerExpeiments')
...
def _argparse():
    ...
    parser.add_argument('-c', '--calleeInfos', required=False, type=str,
                        help='specify dir which contains source files to be parsed',
                        default="/home/nimana11/Thesis/codes/VulExplainerExp-84ED_2/VulExplainerExpeiments/resources/calleeInfos.json")
